...
AFRAME.registerComponent('collision-detector', {
  ...
  init: function () {
    ...
    el.addEventListener('collisions', (e) => {
      ...
      if (collided === 1 && (e.detail.els[0].id || e.detail.els[0].className) && e.detail.els[0].id !== 'playerhead') {
      ...
      } else if (collided === 0 && (e.detail.clearedEls[0].id || e.detail.clearedEls[0].className) && e.detail.clearedEls[0].id !== 'playerhead') {
